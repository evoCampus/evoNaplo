...
const studentFields: FieldConfig<StudentDTO>[] = [
  ...
  { key: "scholarshipDuration", label: "Scholarship Duration", type: "text" },
  ...
  { key: "workExperienceInSemesters", label: "Work Experience", type: "text", fullWidth: true },
...
const toStudentPayload = (student: StudentDTO): CreateStudentDTO | UpdateStudentDTO => ({
  ...
  scholarshipDuration: student.scholarshipDuration || undefined,
  ...
  workExperienceInSemesters: student.workExperienceInSemesters || undefined,
