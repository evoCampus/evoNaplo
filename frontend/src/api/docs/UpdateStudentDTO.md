...
**universityName** | **string** |  | [optional] [default to undefined]
...
```typescript
import { UpdateStudentDTO } from './api';

const instance: UpdateStudentDTO = {
    id,
    name,
    email,
    phoneNumber,
